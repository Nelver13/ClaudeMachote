# Skill: React + Vite
name: react-vite
description: Convenciones y patrones para proyectos React con Vite. Se activa automáticamente al trabajar con componentes, hooks, rutas, estado frontend o vite.config.
